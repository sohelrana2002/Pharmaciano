...
import { createBrand, brandList, brandInfo, updateBrand, deleteBrand } from "../controllers/brandController";
...
// delete brand 
router.delete("/:id", authenticate, authorize(["inventory:manage"]), deleteBrand);

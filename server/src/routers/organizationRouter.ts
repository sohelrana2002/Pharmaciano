...
import { createOrganization, organizationInfo } from "../controllers/organizationController";
...
router.get("/:id", authenticate, authorize(["organization:manage"]), organizationInfo);
